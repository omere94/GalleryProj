...
function makeProjs() {
  gProjs = [
    ...
    },
    {
      ...
      name: "Pacman",
      title: "Pacman",
      desc: "Pacman is an action maze chase video game; the player controls the eponymous characterthrough an enclosed maze",
      url: "/projects/Pacman/index.html",
      picUrl: "02-thumbnail.jpg",
    ...
    },
    {
      ...
      name: "Chess Board",
      title: "Chess Board",
      desc: "A chessboard is the type of gameboard used for the game of chess, on which the chess pawns and pieces are placed",
